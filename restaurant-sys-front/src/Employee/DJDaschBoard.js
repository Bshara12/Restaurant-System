...
export default function DJDaschBoard() {
  ...
  return (
    <div className="maincontainer">
      ...
      <div className={`sidpare ${collapsed ? "collapsed" : ""}`}>
        ...
        <div style={{ width: "100%" }}>
          <Link
            to="/DJ/dashboard/music"
            className={
              activeLink === "/DJ/dashboard/music" ? "active-link" : ""
            }
          >
          ...
          <Link
            to="/DJ/dashboard/Complaints"
            className={
              activeLink === "/DJ/dashboard/Complaints"
                ? "active-link"
                : ""
            }
          >
