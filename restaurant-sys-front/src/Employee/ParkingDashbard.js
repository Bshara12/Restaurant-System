...
export default function ParkingDashbard() {
  ...
  return (
    <div className="maincontainer">
      ...
      <div className={`sidpare ${collapsed ? "collapsed" : ""}`}>
        ...
        <div style={{ width: "100%" }}>
          <Link
            to="/Parking/dashboard/car"
            className={
              activeLink === "/Parking/dashboard/car" ? "active-link" : ""
            }
          >
          ...
          <Link
            to="/Parking/dashboard/Complaints"
            className={
              activeLink === "/Parking/dashboard/Complaints"
                ? "active-link"
                : ""
            }
          >
